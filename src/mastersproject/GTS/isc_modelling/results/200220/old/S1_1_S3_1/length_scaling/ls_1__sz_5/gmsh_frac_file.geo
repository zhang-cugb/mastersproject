...
// Define points
p0 = newp; Point(p0) = {9.479852941436945, 88.8129430871218, 35.34063410406182, 5.0 };
p1 = newp; Point(p1) = {73.15489592735841, 124.38031622898498, 33.5987522940595, 5.0 };
p2 = newp; Point(p2) = {55.927854307073645, 110.82825001955985, 11.358392655664604, 5.0 };
p3 = newp; Point(p3) = {51.07481104762237, 107.79716760340776, 9.639939588007548, 5.0 };
p4 = newp; Point(p4) = {41.92746337987233, 103.73928378247088, 14.620423327478779, 0.5974321088139757 };
p5 = newp; Point(p5) = {49.80187849124779, 100.11836735120961, 6.915861750940508, 5.0 };
p6 = newp; Point(p6) = {72.01962225046807, 106.04324971438463, 33.00662822226959, 5.0 };
p7 = newp; Point(p7) = {55.77074911231656, 108.97855277783891, 35.462759608147806, 5.0 };
p8 = newp; Point(p8) = {46.92973547319694, 109.97320199702921, 35.013990189069446, 0.737166966750488 };
p9 = newp; Point(p9) = {22.35900789492364, 112.73750663428578, 33.766781261255545, 5.0 };
p10 = newp; Point(p10) = {-20.0, 50.0, 75.0, 30.0 };
p11 = newp; Point(p11) = {-20.0, 50.0, -25.0, 30.0 };
p12 = newp; Point(p12) = {-20.0, 150.0, -25.0, 30.0 };
p13 = newp; Point(p13) = {-20.0, 150.0, 75.0, 30.0 };
p14 = newp; Point(p14) = {80.0, 50.0, 75.0, 30.0 };
p15 = newp; Point(p15) = {80.0, 50.0, -25.0, 30.0 };
p16 = newp; Point(p16) = {80.0, 150.0, -25.0, 30.0 };
p17 = newp; Point(p17) = {80.0, 150.0, 75.0, 30.0 };
p18 = newp; Point(p18) = {46.938537014594324, 109.73647813880176, 34.315921793650304, 0.737166966750488 };
p19 = newp; Point(p19) = {42.359950920869174, 103.81964559576548, 15.024677740551066, 0.5974321088139757 };
// End of point specification

// Define lines 
frac_line_0= newl; Line(frac_line_0) = {p0, p18};
Physical Line("FRACTURE_TIP_0") = {frac_line_0};

frac_line_1= newl; Line(frac_line_1) = {p0, p19};
Physical Line("FRACTURE_TIP_1") = {frac_line_1};

frac_line_2= newl; Line(frac_line_2) = {p1, p2};
Physical Line("FRACTURE_TIP_2") = {frac_line_2};

frac_line_3= newl; Line(frac_line_3) = {p1, p18};
Physical Line("FRACTURE_TIP_3") = {frac_line_3};

frac_line_4= newl; Line(frac_line_4) = {p2, p3};
Physical Line("FRACTURE_TIP_4") = {frac_line_4};

frac_line_5= newl; Line(frac_line_5) = {p3, p19};
Physical Line("FRACTURE_TIP_5") = {frac_line_5};

frac_line_6= newl; Line(frac_line_6) = {p4, p5};
Physical Line("FRACTURE_TIP_6") = {frac_line_6};

frac_line_7= newl; Line(frac_line_7) = {p4, p9};
...
frac_line_13= newl; Line(frac_line_13) = {p10, p13};
...
frac_line_16= newl; Line(frac_line_16) = {p11, p15};
...
frac_line_19= newl; Line(frac_line_19) = {p13, p17};
...
frac_line_21= newl; Line(frac_line_21) = {p14, p17};
...
frac_line_23= newl; Line(frac_line_23) = {p16, p17};
Physical Line("AUXILIARY_LINE_23") = {frac_line_23};

frac_line_24= newl; Line(frac_line_24) = {p18, p19};
Physical Line("FRACTURE_LINE_24") = {frac_line_24};
...
Line{frac_line_24} In Surface{fracture_0};
...
Line{frac_line_24} In Surface{fracture_1};
