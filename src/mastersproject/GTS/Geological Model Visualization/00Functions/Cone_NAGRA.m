 function [Cone,EndPlate1,EndPlate2] = Cone_NAGRA(PiezoNAGRA_coords)
%
...
for ii = 1:length(PiezoNAGRA_coords(:,1))
X1 = PiezoNAGRA_coords(ii,1:3);
X1(1,3) = X1(1,3)+4;
X2 = PiezoNAGRA_coords(ii,1:3);
