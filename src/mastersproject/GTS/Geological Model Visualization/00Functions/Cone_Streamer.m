 function [Cone,EndPlate1,EndPlate2] = Cone_Streamer(Piezostreamer_coords)
%
...
for ii = 1:length(Piezostreamer_coords(:,1))
X1 = Piezostreamer_coords(ii,1:3);
X1(1,3) = X1(1,3)+4;
X2 = Piezostreamer_coords(ii,1:3);
