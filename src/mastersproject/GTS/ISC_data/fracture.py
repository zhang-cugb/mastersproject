...
def convex_plane2(shearzone_names, coord_system='gts', path=None):
...
def fracture_network2(shearzone_names, export: bool = False, path=None, **network_kwargs):
    """ Make a fracture network from a selection of shear-zones.
    ...
    convex = convex_plane2(shearzone_names, coord_system='gts', path=path)
