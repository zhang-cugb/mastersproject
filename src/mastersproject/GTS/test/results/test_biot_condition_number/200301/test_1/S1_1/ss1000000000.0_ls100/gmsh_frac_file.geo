...
p4 = newp; Point(p4) = {-0.2, 0.5, 0.75, 0.6 };
p5 = newp; Point(p5) = {-0.2, 0.5, -0.25, 0.6 };
p6 = newp; Point(p6) = {-0.2, 1.5, -0.25, 0.6 };
p7 = newp; Point(p7) = {-0.2, 1.5, 0.75, 0.6 };
p8 = newp; Point(p8) = {0.8, 0.5, 0.75, 0.6 };
p9 = newp; Point(p9) = {0.8, 0.5, -0.25, 0.6 };
p10 = newp; Point(p10) = {0.8, 1.5, -0.25, 0.5861592711281698 };
p11 = newp; Point(p11) = {0.8, 1.5, 0.75, 0.4916591256043915 };
