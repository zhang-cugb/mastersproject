...
// Define points
p0 = newp; Point(p0) = {-0.2, 0.5, 0.75, 0.6 };
p1 = newp; Point(p1) = {-0.2, 0.5, -0.25, 0.6 };
p2 = newp; Point(p2) = {-0.2, 1.5, -0.25, 0.6 };
p3 = newp; Point(p3) = {-0.2, 1.5, 0.75, 0.6 };
p4 = newp; Point(p4) = {0.8, 0.5, 0.75, 0.6 };
p5 = newp; Point(p5) = {0.8, 0.5, -0.25, 0.6 };
p6 = newp; Point(p6) = {0.8, 1.5, -0.25, 0.6 };
p7 = newp; Point(p7) = {0.8, 1.5, 0.75, 0.6 };
