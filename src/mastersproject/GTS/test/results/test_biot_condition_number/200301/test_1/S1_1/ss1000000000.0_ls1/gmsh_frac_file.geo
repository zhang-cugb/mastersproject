...
p4 = newp; Point(p4) = {-20.0, 50.0, 75.0, 60.0 };
p5 = newp; Point(p5) = {-20.0, 50.0, -25.0, 60.0 };
p6 = newp; Point(p6) = {-20.0, 150.0, -25.0, 60.0 };
p7 = newp; Point(p7) = {-20.0, 150.0, 75.0, 60.0 };
p8 = newp; Point(p8) = {80.0, 50.0, 75.0, 60.0 };
p9 = newp; Point(p9) = {80.0, 50.0, -25.0, 60.0 };
