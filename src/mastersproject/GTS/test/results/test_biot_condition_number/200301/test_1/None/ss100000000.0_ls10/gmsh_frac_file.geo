...
// Define points
p0 = newp; Point(p0) = {-2.0, 5.0, 7.5, 6.0 };
p1 = newp; Point(p1) = {-2.0, 5.0, -2.5, 6.0 };
p2 = newp; Point(p2) = {-2.0, 15.0, -2.5, 6.0 };
p3 = newp; Point(p3) = {-2.0, 15.0, 7.5, 6.0 };
p4 = newp; Point(p4) = {8.0, 5.0, 7.5, 6.0 };
p5 = newp; Point(p5) = {8.0, 5.0, -2.5, 6.0 };
p6 = newp; Point(p6) = {8.0, 15.0, -2.5, 6.0 };
p7 = newp; Point(p7) = {8.0, 15.0, 7.5, 6.0 };
