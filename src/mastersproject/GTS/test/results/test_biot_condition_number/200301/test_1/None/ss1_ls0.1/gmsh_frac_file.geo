...
// Define points
p0 = newp; Point(p0) = {-200.0, 500.0, 750.0, 600.0 };
p1 = newp; Point(p1) = {-200.0, 500.0, -250.0, 600.0 };
p2 = newp; Point(p2) = {-200.0, 1500.0, -250.0, 600.0 };
p3 = newp; Point(p3) = {-200.0, 1500.0, 750.0, 600.0 };
p4 = newp; Point(p4) = {800.0, 500.0, 750.0, 600.0 };
p5 = newp; Point(p5) = {800.0, 500.0, -250.0, 600.0 };
p6 = newp; Point(p6) = {800.0, 1500.0, -250.0, 600.0 };
p7 = newp; Point(p7) = {800.0, 1500.0, 750.0, 600.0 };
