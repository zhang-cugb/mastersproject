...
// Define points
p0 = newp; Point(p0) = {-6.0, 55.0, 50.0, 10.0 };
p1 = newp; Point(p1) = {-6.0, 55.0, 0.0, 10.0 };
p2 = newp; Point(p2) = {-6.0, 150.0, 0.0, 10.0 };
p3 = newp; Point(p3) = {-6.0, 150.0, 50.0, 10.0 };
p4 = newp; Point(p4) = {80.0, 55.0, 50.0, 10.0 };
p5 = newp; Point(p5) = {80.0, 55.0, 0.0, 10.0 };
p6 = newp; Point(p6) = {80.0, 150.0, 0.0, 10.0 };
p7 = newp; Point(p7) = {80.0, 150.0, 50.0, 10.0 };
